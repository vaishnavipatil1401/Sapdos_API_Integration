...
import 'package:sapdos_api_integration_assignment/presentation/pages/register_screen.dart';
...
import 'package:sapdos_api_integration_assignment/injection/service_locator.dart';
  ...
  Widget build(BuildContext context) {
    return MultiBlocProvider(
      ...
      child: MaterialApp(
        ...
        initialRoute: '/register', // Set the initial route to the register screen
        routes: {
          '/': (context) => LoginScreen(),
